...
function isValidEmail(v) {
  // เบา ๆ พอสำหรับฟอร์มล็อกอิน
  return /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(v.trim());
}
const ErrorLine = ({ children }) => (
  <div className="mt-1 flex items-start gap-1 rounded-lg border border-red-500/30 bg-red-500/10 px-2 py-1 text-[12px] text-red-300">
    <svg
      viewBox="0 0 24 24"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-950">
      <div className="w-full max-w-md rounded-2xl bg-slate-900 ring-1 ring-white/10 p-6 shadow-xl">
        ...
        {/* ปิด native tooltip ของเบราเซอร์ */}
